...
function renderTemplate(templateStr, data) {
  ...
  result = result.replace(/\{\{\s*current_mod\s*\}\}/g, data.current_mod || '');
  result = result.replace(/\{\{\s*current_id\s*\}\}/g, data.current_id || '');
  result = result.replace(/\{\{\s*total_topics\s*\|\s*default\(0\)\s*\}\}/g, data.total_topics || '0');
  result = result.replace(/\{\{\s*total_topics\s*\}\}/g, data.total_topics || '0');
